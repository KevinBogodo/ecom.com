    ...
    <div class="container">
        <div class="row">
          <div class="col-md-3 col-sm-6 col-xs-12 segment-one md-mb-30 sm-mb-30">
            <h2>Blanche ETOA Mengue</h2>
            <p>SKMLKFLKMLKLKMLKL LDKLKML LMKL LMSKMLFKSL LDKSMKLK LDKSMFK MLKSDLMKMFLS LDKSMK,pdqps doqpds dqpsdsq qpds sqd sq d sqd qsd</p>
          </div>
          ...
          <div class="col-md-3 col-sm-6 col-xs-12 segment-four md-mb-30 sm-mb-30">
              <h2>Our newsleter</h2>
              <p>azer, oppoo kp ko kpop oklkzaef fezfàe ef sdqffdsf dffsdfd. sfsdfz</p>
              <form class="" action="">
                <input type="email">
